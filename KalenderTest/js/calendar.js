...
(function($) {
	...
	var defaults = {
		...
		// Kalenders bredde
		width: '100%',
		// Første view (kan være 'måned', 'uke', 'dag')
		view: 'month',
		// Første dato
		day: 'now',
		// Dagers start og slutttid med intervaller
		time_start: '06:00',
		time_end: '22:00',
		time_split: '30',
        
		//   viser en array med events 
		events_source: '',
		// Static cache med events. Vil kun laste inn events 1 gang hvis den settes til True
		events_cache: false,
		// bruker 24 timers format istedenfor 12 timers
		format12: false,
		am_suffix: "AM",
		pm_suffix: "PM",
	// bootstrap templates 
		...
		// Elementet sin ID til et modal vindu. Kan brukes for å åpne event i et modal vindu.
		modal: null,
		modal_type: "iframe",
		modal_title: null,
		views: {
...
// Spesielle dager
	var defaults_extended = {
		...
		holidays: {
			...
			// Tredje (+3*) Manda (1) i Januar(01)
			'01+3*1': "Birthday of Dr. Martin Luther King, Jr.",
			// Tredje (+3*) Mandag (1) i Februar (02)
			'02+3*1': "Washington's Birthday",
			// Siste (-1*) Mandag (1) i  Mai (05)
			'05-1*1': "Memorial Day",
			'04-07': "Independence Day",
			// Første (+1*) Mandag (1) i September (09)
			'09+1*1': "Labor Day",
			'10+2*1': "Columbus Day",
			'11-11': "Veterans Day",
